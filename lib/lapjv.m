...
minh = 0; % fixed for Matlab coder by Anh
endofpath = 0; % fixed for Matlab coder by Anh
for f=1:numfree
    ...
    while ~unassignedfound
        ...
        if ~unassignedfound
            ...
            i2 = i2(1); % Add by AnhNguyen for Matlab Coder
    ...
    while 1
        ...
        endofpath=rowsol(i);
        rowsol(i)=j1;
        if (i(1)==freerow) % Fixed for matlab coder by Anh
            break
        end
    end
end
